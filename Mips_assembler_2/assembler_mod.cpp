...
int main()
{
    ...
    R_TYPE = parse("R_TYPE.txt");
    I_TYPE = parse("I_TYPE.txt");
    J_TYPE = parse("J_TYPE.txt");
    RegisterValue = parse("RegisterValue.txt");
    ifstream inputFile("input.txt");
//    ifstream inputFile("validtestcases.txt");
    //ifstream inputFile("File/invalidtestcases.txt");
    ofstream outputFile1("output2.txt");
    int count = 0;
